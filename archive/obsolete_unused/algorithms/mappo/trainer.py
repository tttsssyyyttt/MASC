...
class MAPPOTrainer:
    """Handles the training loop for MAPPO (on-policy)."""
    ...
    def train(self) -> dict:
        ...
        for ep in range(self.max_episodes):
            ...
            # Update after each episode (MAPPO is on-policy, updates once per rollout)
            ...
            if (ep + 1) % self.eval_interval == 0:
                ...
                if eval_reward > best_eval_reward:
                    ...
                    self.agent.save("checkpoints/mappo_best.pt")
