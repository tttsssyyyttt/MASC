...
def run_compare(args):
    ...
    rl_configs = [
        ...
        ("QMIX", "qmix", False, dict(hidden_dim=128, lr=5e-4, gamma=0.99, buffer_capacity=20000, batch_size=64, target_update_freq=100, mixer_hidden=32)),
        ("IQL", "iql", False, dict(hidden_dim=128, lr=5e-4, gamma=0.99, buffer_capacity=20000, batch_size=64, epsilon_decay=12000, target_update_freq=200, encoder_update_freq=8)),
    ]
